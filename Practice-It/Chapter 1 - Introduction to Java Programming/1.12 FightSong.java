...
In particular, make sure that main contains no System.out.println statements, that any
System.out.println statement(s) repeated are captured in a method that is called just once,
...
    }
    
    public static void goYouLineGoYou() {
        goYou();
        line();
        goYou();
    }
    
    public static void goYou() {
        go();
        you();
    }
    
