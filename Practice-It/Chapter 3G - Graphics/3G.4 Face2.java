/**********************************************************************************************
Modify your Face program from the previous exercise into a new class Face2 to draw the new
output shown below. The window size should be changed to 520 x 180 pixels, and the faces'
top-left corners are at (10, 30), (110, 30), (210, 30), (310, 30), and (410, 30). Draw the
figures using a loop to avoid redundancy.
