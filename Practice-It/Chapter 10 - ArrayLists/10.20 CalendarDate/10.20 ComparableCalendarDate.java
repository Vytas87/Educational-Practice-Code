/**********************************************************************************************
Suppose that a class CalendarDate has been defined for storing a calendar date with month, day
and year components. The class includes the following members:
...
You may assume that dates are constructed with appropriate values: Months will be between 1 and
12, days will be between 1 and 31 and years will be four-digit numbers. Assume that the toString
method produces a standard format with two digits for the month and two digits for the day,
including leading zeros if necessary. For example, January 7th, 2005, would return the string
"2005/01/07".
***********************************************************************************************/
