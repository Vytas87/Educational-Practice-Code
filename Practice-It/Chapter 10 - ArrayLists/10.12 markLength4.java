...
string of four asterisks "****" in front of every string of length 4. For example, suppose that
a variable called list contains the following values: {"this", "is", "lots", "of", "fun", "for",
...
Notice that you leave the original strings in the list, "this", "lots", "Java", but include th
